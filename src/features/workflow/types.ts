...
export interface ReviewStep { key: string; profile_ids: string[] }
export const defaultReviewSteps: ReviewStep[] = ['review-rules', 'review-continuity', 'review-plausibility'].map((key) => ({ key, profile_ids: [] }))
